        ...
        try {
            ...
            if (data) {
                ...
                const participantResult: ParticipantResult = {
                    ...
                    chestNumber: data.chest_number || firstParticipation?.chest_number || searchTerm,
            ...
            <header className="bg-white shadow-sm sticky top-0 z-10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
                    <div className="flex items-center space-x-3">
                        ...
                        <h1 className="text-xl font-bold text-textDark">Kalamela '25 <span className="text-primary font-normal">Results</span></h1>
                    </div>
